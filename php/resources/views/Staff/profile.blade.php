        ...
        <div class="col-md-3">
            ...
            <div class="box box-primary">
                <div class="box-body box-profile">
                    <img class="profile-user-img img-responsive img-circle" style="width: 120px;height: 120px;"
                    ...
                    <p class="text-muted pull-right">
                        @switch($UserInfo['UserCountryControl'])
                            ...
                            <img src="/img/latinoamericawico.png"
                                 style="width:20px;background-color: #5fabb2;border-radius:50%;" data-toggle="tooltip"
